...
require('./oec-nav-menu-action-df8830b0.js');
require('./oec-user-icon-3a0c2f95.js');
const Overlay = require('./Overlay-5fe219ef.js');

const MyIconBellSolid = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", fill: "currentColor" }, attrs),
...
const MyIconBento = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", width: "20", height: "16", fill: "currentColor" }, attrs),
  index.h("path", { d: "M4.08.18a2.38 2.38 0 1 0-.001 4.759A2.38 2.38 0 0 0 4.08.18Zm0 5.44a2.38 2.38 0 1 0-.001 4.759A2.38 2.38 0 0 0 4.08 5.62Zm0 5.44a2.38 2.38 0 1 0-.001 4.759 2.38 2.38 0 0 0 .001-4.759Zm12.25-6.12a2.38 2.38 0 1 0 .001-4.759 2.38 2.38 0 0 0-.001 4.759Zm0 .68a2.38 2.38 0 1 0-.001 4.759 2.38 2.38 0 0 0 .001-4.759ZM10.2.18a2.38 2.38 0 1 0-.001 4.759A2.38 2.38 0 0 0 10.2.18Zm0 10.88a2.38 2.38 0 1 0-.001 4.759 2.38 2.38 0 0 0 .001-4.759Zm6.12 0a2.38 2.38 0 1 0-.001 4.759 2.38 2.38 0 0 0 .001-4.759ZM10.2 5.62a2.38 2.38 0 1 0-.001 4.759A2.38 2.38 0 0 0 10.2 5.62Z", "data-name": "Layer 1" })));

const MyIconCommentDotsSolid = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", fill: "currentColor" }, attrs),
...
function tooltip(configuration) {
  ...
  return {
    ...
    register: (itemElement) => {
      const update$ = new index$1.Subject();
      const show$ = new index$1.Subject();
      const hide$ = new index$1.Subject();
      const destroy$ = new index$1.ReplaySubject(1);
      ...
      index$1.merge(show$.pipe(index$1.map(() => true)), hide$.pipe(index$1.map(() => false)))
        .pipe(index$1.switchMap(isExpectedToShow => index$1.of(isExpectedToShow).pipe(index$1.delay(isExpectedToShow ? config.showDelay : config.hideDelay))), index$1.distinctUntilChanged(), index$1.takeUntil(destroy$)).subscribe(async (isExpectedToShow) => {
        if (isExpectedToShow) {
...
const OecNav = class {
  constructor(hostRef) {
    ...
    this.notificationsClicked = index.createEvent(this, "notificationsClicked", 7);
    this.messagesClicked = index.createEvent(this, "messagesClicked", 7);
    this.helpClicked = index.createEvent(this, "helpClicked", 7);
    this.bentoClicked = index.createEvent(this, "bentoClicked", 7);
    this.overlayRefs = [];
    ...
    this.attachMenuItemBehaviors = async (el) => {
      this.overlayRefs.push(await Overlay.Overlay.attach(el, {
      ...
      if (el.classList.contains('bento')) {
        this.overlayRefs.push(await Overlay.Overlay.attach(el, {
          template: () => index.h("oec-app-launcher", { class: "bento-popover-content" }),
  ...
  connectedCallback() {
    const shared = index$1.interval(1000).pipe(index$1.shareReplay({
      bufferSize: 1,
      refCount: true
    }));
    shared.pipe(index$1.takeUntil(this.destroy$)).subscribe(x => {
      this.missedNotifications = x;
    });
    shared.pipe(index$1.scan((acc, value) => (value % 3) === 0 && value !== 0 ? (acc + 1) : acc, 0), // every 3 seconds
    index$1.distinctUntilChanged(), index$1.takeUntil(this.destroy$)).subscribe(x => {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "left" }, index.h("slot", { name: "brand" })), index.h("div", { class: "right" }, index.h("oec-nav-menu-action", { class: "search", isClickable: false, "data-tooltip": "Search", ref: this.attachMenuItemBehaviors }, index.h("oec-nav-search", { slot: "icon" })), index.h("oec-nav-menu-action", { class: "help", "data-tooltip": "Support", onClick: this.onHelpClick, ref: this.attachMenuItemBehaviors }, index.h(MyIconCircleQuestionRegular, { slot: "icon", style: styles })), index.h("oec-nav-menu-action", { class: "notifications", "data-tooltip": "Notifications", badgeTotal: this.missedNotifications, onClick: this.onNotificationsClicked, ref: this.attachMenuItemBehaviors }, index.h(MyIconBellSolid, { slot: "icon", style: styles })), index.h("oec-nav-menu-action", { class: "messages", "data-tooltip": "Alerts", badgeTotal: this.missedMessages, onClick: this.onMessagesClicked, ref: this.attachMenuItemBehaviors }, index.h(MyIconCommentDotsSolid, { slot: "icon", style: styles })), index.h("oec-nav-menu-action", { class: "user-info", "data-tooltip": "User Info", isClickable: false, ref: this.attachMenuItemBehaviors }, index.h("oec-user-icon", { slot: "icon", style: { width: "20px", height: "20px" }, userId: this.userId })), index.h("div", { class: "vertical-divider" }), index.h("oec-nav-menu-action", { class: "bento", onClick: this.onBentoClicked, "data-tooltip": "App Launcher", ref: this.attachMenuItemBehaviors }, index.h("div", { slot: "icon", class: "bento-content" }, index.h(MyIconOecLogo, { focusable: "false" }), index.h(MyIconBento, { focusable: "false" }))))));
  }
};
OecNav.style = oecNavCss;

exports.oec_nav = OecNav;
