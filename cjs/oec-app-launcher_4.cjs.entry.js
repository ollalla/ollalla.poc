...
const Overlay = require('./Overlay-ff47fdfb.js');
const Subject = require('./Subject-5132b51b.js');

function filter(predicate, thisArg) {
    return Overlay.operate((source, subscriber) => {
        let index = 0;
        source.subscribe(Overlay.createOperatorSubscriber(subscriber, (value) => predicate.call(thisArg, value, index++) && subscriber.next(value)));
    });
}
...
function debounce(durationSelector) {
    return Overlay.operate((source, subscriber) => {
        ...
        source.subscribe(Overlay.createOperatorSubscriber(subscriber, (value) => {
            durationSubscriber === null || durationSubscriber === void 0 ? void 0 : durationSubscriber.unsubscribe();
            hasValue = true;
            lastValue = value;
            durationSubscriber = Overlay.createOperatorSubscriber(subscriber, emit, Subject.noop);
            Overlay.innerFrom(durationSelector(value)).subscribe(durationSubscriber);
        }, () => {
            emit();
            subscriber.complete();
        }, undefined, () => {
...
const OecOecIcon = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 35 35" }, attrs),
  index.h("path", { d: "M22.91,6.38c0,2.93-2.37,5.3-5.3,5.3s-5.3-2.37-5.3-5.3S14.69,1.09,17.62,1.09s5.3,2.37,5.3,5.3Z", fill: "#54565a" }),
  index.h("path", { d: "M11.67,17.68c0,2.92-2.37,5.3-5.3,5.3s-5.3-2.37-5.3-5.3,2.37-5.3,5.3-5.3,5.3,2.37,5.3,5.3Z", fill: "#003b71" }),
  index.h("path", { d: "M34.16,17.69c0,2.92-2.37,5.29-5.3,5.29s-5.3-2.37-5.3-5.29,2.37-5.3,5.3-5.3,5.3,2.37,5.3,5.3Z", fill: "#54565a" }),
  index.h("path", { d: "M22.91,28.88c0,2.93-2.37,5.3-5.3,5.3s-5.3-2.37-5.3-5.3,2.37-5.3,5.3-5.3,5.3,2.37,5.3,5.3Z", fill: "#54565a" })));

const sty1 = { isolation: "isolate" };
const sty2 = { mixBlendMode: "darken" };
const sty3 = { mixBlendMode: "multiply", opacity: 0.57 };
const OecOpsIcon = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 38 38" }, attrs),
  index.h("defs", null,
    index.h("linearGradient", { id: "Degradado_sin_nombre_70", x1: "19", y1: "-15455.33", x2: "19", y2: "-15419", gradientTransform: "translate(0 -15418) scale(1 -1)", gradientUnits: "userSpaceOnUse" },
      index.h("stop", { offset: "0", "stop-color": "#fff" }),
      index.h("stop", { offset: "0", "stop-color": "#fff" }),
      index.h("stop", { offset: "0", "stop-color": "#dbdce0" }),
      index.h("stop", { offset: "1", "stop-color": "#747478" }))),
  index.h("g", Object.assign({}, sty1),
    index.h("g", { id: "Capa_1" },
      index.h("circle", { id: "grey-circle", cx: "19", cy: "19", r: "18", width: "38", height: "38", fill: "#8993A9" }),
      ...
      index.h("path", { id: "outer-grad-circle", fill: "url(#Degradado_sin_nombre_70)", d: "M19,1.41c4.7,0,9.12,1.85,12.44,5.2,3.32,3.35,5.15,7.81,5.15,12.55s-1.83,9.2-5.15,12.55c-3.32,3.35-7.74,5.2-12.44,5.2s-9.12-1.85-12.44-5.2c-3.32-3.35-5.15-7.81-5.15-12.55S3.24,9.97,6.56,6.61C9.88,3.26,14.3,1.41,19,1.41m0-.41C9.06,1,1,9.13,1,19.16s8.06,18.16,18,18.16,18-8.13,18-18.16S28.94,1,19,1h0Z" }),
      index.h("g", Object.assign({}, sty2),
        index.h("path", { id: "inner-blur-circle1", fill: "#005787", d: "M19,3.05c4.27,0,8.29,1.69,11.31,4.77,3.02,3.08,4.69,7.17,4.69,11.52s-1.66,8.44-4.69,11.52c-3.02,3.08-7.04,4.77-11.31,4.77s-8.29-1.69-11.31-4.77c-3.02-3.08-4.69-7.17-4.69-11.52s1.66-8.44,4.69-11.52c3.02-3.08,7.04-4.77,11.31-4.77m0-.41C9.94,2.64,2.6,10.11,2.6,19.34s7.34,16.7,16.4,16.7,16.4-7.48,16.4-16.7S28.06,2.64,19,2.64h0Z" }),
        index.h("g", null,
          index.h("path", { id: "inner-blur-circle2", fill: "#14314f", opacity: "0.3", d: "M19,3.05c4.27,0,8.29,1.69,11.31,4.77,3.02,3.08,4.69,7.17,4.69,11.52s-1.66,8.44-4.69,11.52c-3.02,3.08-7.04,4.77-11.31,4.77s-8.29-1.69-11.31-4.77c-3.02-3.08-4.69-7.17-4.69-11.52s1.66-8.44,4.69-11.52c3.02-3.08,7.04-4.77,11.31-4.77m0-.41C9.94,2.64,2.6,10.11,2.6,19.34s7.34,16.7,16.4,16.7,16.4-7.48,16.4-16.7S28.06,2.64,19,2.64h0Z" }))),
      index.h("g", { id: "letters" },
        index.h("g", null,
          index.h("path", { fill: "#005787", d: "M8.56,15.66h4.42c.29,0,.55,.05,.79,.14,.24,.09,.41,.22,.52,.38,.18,.25,.16,.69-.07,1.31l-1.02,2.73c-.23,.62-.54,1.06-.91,1.31-.22,.16-.49,.28-.8,.38-.31,.09-.61,.14-.89,.14H6.18c-.29,0-.55-.05-.79-.14-.24-.09-.41-.22-.51-.38-.19-.25-.16-.69,.06-1.31l1.02-2.73c.24-.62,.54-1.06,.91-1.31,.22-.16,.49-.28,.8-.38,.31-.09,.6-.14,.89-.14m-.61,4.14c-.13,.4-.02,.75,.48,.75h1.03c.71,.02,.92-.44,1.04-.75l.77-2.08c.16-.44,.21-.8-.49-.8h-1.15c-.68,0-.9,.67-1.68,2.88" }),
          index.h("path", { fill: "#005787", d: "M18.17,19.76l-.5,1.33c-.14,.42-.15,.74-.03,.95h-3.48c.28-.22,.5-.54,.67-.95l1.67-4.49c.14-.41,.15-.72,.04-.94h6.19c1.47,0,1.78,.42,1.53,1.24l-.58,1.5c-.37,.83-.82,1.36-2.48,1.36h-3.04Zm.4-1.06h1.46c.7,0,.73-.1,.97-.6l.17-.44c.32-.73-.05-.73-.33-.73h-1.61l-.66,1.78Z" }),
          index.h("path", { fill: "#005787", d: "M33.51,15.66l-.6,1.41c-.18-.16-1.07-.15-.99-.15h-2.51c-.13,0-.41,0-.45,0-.2,0-.35,.08-.43,.25-.06,.14-.15,.38-.16,.41-.06,.16,.14,.2,.26,.2,.02,0,2.29,0,2.75,0,0,0,1.45,0,1,1.27l-.65,1.68c-.55,1.39-.86,1.31-1.97,1.31h-5.85l.61-1.58c.18,.1,.45,.19,.63,.22,.18,.03,.52,.04,1.02,.04h2.2c.35,0,.4,0,.48-.02,.13-.03,.18-.14,.2-.18,.02-.06,.17-.43,.2-.5,.09-.24-.15-.24-.29-.24h-2.14c-.54,0-.46,0-.76,0-.59,0-1.23-.01-.87-1.04l.7-1.76c.18-.44,.48-1.32,2.49-1.32h5.14Z" })),
        index.h("g", Object.assign({}, sty3),
          index.h("path", { fill: "#1a2848", d: "M8.56,15.66h4.42c.29,0,.55,.05,.79,.14,.24,.09,.41,.22,.52,.38,.18,.25,.16,.69-.07,1.31l-1.02,2.73c-.23,.62-.54,1.06-.91,1.31-.22,.16-.49,.28-.8,.38-.31,.09-.61,.14-.89,.14H6.18c-.29,0-.55-.05-.79-.14-.24-.09-.41-.22-.51-.38-.19-.25-.16-.69,.06-1.31l1.02-2.73c.24-.62,.54-1.06,.91-1.31,.22-.16,.49-.28,.8-.38,.31-.09,.6-.14,.89-.14m-.61,4.14c-.13,.4-.02,.75,.48,.75h1.03c.71,.02,.92-.44,1.04-.75l.77-2.08c.16-.44,.21-.8-.49-.8h-1.15c-.68,0-.9,.67-1.68,2.88" }),
          index.h("path", { fill: "#1a2848", d: "M18.17,19.76l-.5,1.33c-.14,.42-.15,.74-.03,.95h-3.48c.28-.22,.5-.54,.67-.95l1.67-4.49c.14-.41,.15-.72,.04-.94h6.19c1.47,0,1.78,.42,1.53,1.24l-.58,1.5c-.37,.83-.82,1.36-2.48,1.36h-3.04Zm.4-1.06h1.46c.7,0,.73-.1,.97-.6l.17-.44c.32-.73-.05-.73-.33-.73h-1.61l-.66,1.78Z" }),
          index.h("path", { fill: "#1a2848", d: "M33.51,15.66l-.6,1.41c-.18-.16-1.07-.15-.99-.15h-2.51c-.13,0-.41,0-.45,0-.2,0-.35,.08-.43,.25-.06,.14-.15,.38-.16,.41-.06,.16,.14,.2,.26,.2,.02,0,2.29,0,2.75,0,0,0,1.45,0,1,1.27l-.65,1.68c-.55,1.39-.86,1.31-1.97,1.31h-5.85l.61-1.58c.18,.1,.45,.19,.63,.22,.18,.03,.52,.04,1.02,.04h2.2c.35,0,.4,0,.48-.02,.13-.03,.18-.14,.2-.18,.02-.06,.17-.43,.2-.5,.09-.24-.15-.24-.29-.24h-2.14c-.54,0-.46,0-.76,0-.59,0-1.23-.01-.87-1.04l.7-1.76c.18-.44,.48-1.32,2.49-1.32h5.14Z" })))))));
...
const OecAppLauncher = class {
  constructor(hostRef) {
    ...
    this.appCardClicked = index.createEvent(this, "appCardClicked", 7);
    ...
    this.destroy$ = new Overlay.ReplaySubject();
    ...
    this.handleViewAll = async (ev) => {
      const ref = await Overlay.Overlay.attach(ev.target, {
        template: ({ hide }) => (index.h("div", null, index.h("button", { onClick: hide }, "close"))),
  ...
  connectedCallback() {
    Overlay.from(this.appService.getAppListing())
      .pipe(Overlay.takeUntil(this.destroy$))
      .subscribe(data => {
  ...
  appTemplateRender(app) {
    return this.enabledApps.includes(app.name) ? (index.h("oec-app-card", { onClick: this.onAppCardClicked(app.landingUrl), appDefinition: app })) : ("");
  }
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: this.oneColumn
        ? "launcher-component one-column"
        : "launcher-component" }, index.h("div", { class: "headWrapper" }, this.hasOps ? (index.h("header", { class: this.oneColumn ? "one-column" : "" }, index.h(OecOpsIcon, { style: this.iconStyleOps }))) : (""), this.hasOec ? (index.h("header", { class: this.oneColumn ? "one-column" : "" }, index.h(OecOecIcon, { style: this.iconStyleOec }))) : ("")), index.h("div", { class: "appsWrapper" }, index.h("div", { class: this.hasOps ? "products-column" : "hidden" }, getSortedItems(x => x.isOpsProduct).map(this.appTemplateRender.bind(this))), index.h("div", { class: this.hasOec ? "products-column" : "hidden" }, getSortedItems(x => !x.isOpsProduct).map(this.appTemplateRender.bind(this)))), this.viewAllVisible ? (index.h("div", { class: "view-all", onClick: this.handleViewAll }, "View All")) : (""))));
  }
};
OecAppLauncher.style = oecAppLauncherCss;

const MyIconMagnifyingGlassSolid = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", fill: "currentColor" }, attrs),
  index.h("path", { d: "M500.3 443.7 380.6 324c27.22-40.41 40.65-90.9 33.46-144.7C401.8 87.79 326.8 13.32 235.2 1.723 99.01-15.51-15.51 99.01 1.724 235.2c11.6 91.64 86.08 166.7 177.6 178.9 53.8 7.189 104.3-6.236 144.7-33.46l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0 15.606-15.64 15.606-41.04.006-56.64zM79.1 208c0-70.58 57.42-128 128-128s128 57.42 128 128-57.42 128-128 128-128-57.4-128-128z" })));

const MyIconXmarkSolid = (attrs) => (index.h("svg", Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512", fill: "currentColor" }, attrs),
  index.h("path", { d: "M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25-6.2 6.25-14.4 9.35-22.6 9.35s-16.38-3.125-22.62-9.375L160 301.3 54.63 406.6C48.38 412.9 40.19 416 32 416s-16.37-3.1-22.625-9.4c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z" })));
...
const NavSearch = class {
  constructor(hostRef) {
    ...
    this.destroy$ = new Overlay.ReplaySubject(1);
    this.key$ = new Subject.Subject();
  ...
  connectedCallback() {
    this.key$.pipe(debounce((key) => key === 'Enter' ? Overlay.timer(0) : Overlay.timer(3000)), Overlay.switchMap(() => Overlay.of((this.searchInput.value || '').trim())), filter(x => !!x && x.length > 3), // greater than 3 characters
    Overlay.distinctUntilChanged(), Overlay.takeUntil(this.destroy$)).subscribe(() => {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      } }, index.h("input", { type: "text", placeholder: "search...", ref: (el) => this.searchInput = el, onFocus: this.onSearchInputFocused, onBlur: this.onSearchInputBlurred }), index.h("button", null, (this.isExpanded || this.isFocused) ? index.h(MyIconXmarkSolid, { onClick: this.handleExitSearch }) : index.h(MyIconMagnifyingGlassSolid, { onClick: this.onMagnifyingGlassSolidClicked })))));
  }
};
NavSearch.style = oecNavSearchCss;

exports.oec_nav_menu_action = Overlay.OecNavMenuAction;
exports.oec_user_icon = Overlay.OecUserIcon;
exports.oec_app_launcher = OecAppLauncher;
exports.oec_nav_search = NavSearch;
