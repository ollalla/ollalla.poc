...
const Overlay = require('./Overlay-5fe219ef.js');
...
const OecAppLauncher = class {
  constructor(hostRef) {
    ...
    this.destroy$ = new index$1.ReplaySubject();
  ...
  connectedCallback() {
    index$1.from(this.appService.getAppListing())
      .pipe(index$1.takeUntil(this.destroy$))
      .subscribe(data => {
