...
import { g as take, R as ReplaySubject, h as from, t as takeUntil } from './index2.js';
import './index3.js';
import { d as defineCustomElement$1 } from './oec-app-card2.js';
...
const OecAppLauncher = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    ...
    this.handleViewAll = async (ev) => {
      const ref = await Overlay$1.attach(ev.target, {
  ...
  static get style() { return oecAppLauncherCss; }
}, [1, "oec-app-launcher", {
    "enabledApps": [16],
    "allowedApps$": [32]
  }]);
function defineCustomElement() {
  ...
  const components = ["oec-app-launcher", "oec-app-card"];
  components.forEach(tagName => { switch (tagName) {
    case "oec-app-launcher":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, OecAppLauncher);
      }
      break;
    case "oec-app-card":
      if (!customElements.get(tagName)) {
...
defineCustomElement(OecAppLauncher);

export { OecAppLauncher as O, Overlay$1 as a, defineCustomElement as d };
