...
import { R as ReplaySubject, S as Subject, j as debounce, k as timer, s as switchMap, o as of, l as filter, b as distinctUntilChanged, t as takeUntil } from './index2.js';
import './index3.js';
...
const NavSearch = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return oecNavSearchCss; }
}, [1, "oec-nav-search", {
    "isMouseOver": [32],
    "isForcedOpen": [32],
    "isFocused": [32]
  }, [[1, "mouseover", "handleMouseOver"], [1, "mouseout", "handleMouseOut"], [1, "keydown", "handleKeyDown"]]]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["oec-nav-search"];
  components.forEach(tagName => { switch (tagName) {
    case "oec-nav-search":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, NavSearch);
      }
      break;
  } });
}
defineCustomElement(NavSearch);

export { NavSearch as N, defineCustomElement as d };
